...
export async function createForumTopicAction(
  ...
  if (
    ...
    return {
      success: false,
      message:
        "You do not have permission to write in this forum section.",
      fieldErrors: {
        sectionId:
          "Choose a forum section you may write in.",
      },
    };
  }
...
export async function createForumReplyAction(
  ...
  if (
    ...
    return {
      success: false,
      message:
        "You do not have permission to reply in this forum section.",
    };
  }
