...
create_file(
    ROOT / "app/(portal)/admin/safety/actions.ts",
    actions,
    "Online Safety review action",
)

create_file(
    ROOT / "app/(portal)/admin/safety/page.tsx",
    page,
...
''',
    '''            <AdminNavigationLink href="/admin/communication-logs">
            ...
            <AdminNavigationLink href="/admin/rooms">
''',
    "Admin Safety navigation",
)

print("")
print("Job 7 patch complete.")
print("Next:")
print("  1. Run job7-online-safety-register.sql in Supabase.")
