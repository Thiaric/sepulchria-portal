...
function EquipmentFigure({
  ...
  return (
    <section className="relative z-10 mt-5 overflow-visible border border-[rgb(var(--sep-colour-60482e))]/45 bg-[rgb(var(--sep-colour-100c09))] components_characters_character_inventory_browser_section_section">
      ...
      {!collapsed ? (
        <>
          <div className="relative hidden grid-cols-[minmax(175px,1fr)_minmax(280px,340px)_minmax(175px,1fr)] items-start gap-5 overflow-visible p-5 md:grid lg:gap-8 lg:p-7 components_characters_character_inventory_browser_div_container_38">
            <div className="min-w-0 space-y-4 components_characters_character_inventory_browser_div_container_39">
              {LEFT_EQUIPMENT_SLOTS.map(
                (slot) =>
                  slotCard(slot),
              )}
            </div>
