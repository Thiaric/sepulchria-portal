...
export function NpcControlPanel({roomId}:{roomId:string}){
  ...
  function beginCreate(){setCreating(true);setSelectedId("");setName("");setPronouns("");setPortraitUrl("");setDescription("");setRaceId("");setOrderId("");setActive(true);setPostText("");setStatus("");}
  ...
  return <div className="space-y-3">
    ...
    {(creating||selected)&&<>
      ...
      {!creating&&selected?.character_id?<div className="flex flex-wrap gap-2 border-t border-[rgb(var(--sep-colour-60482e))]/30 pt-2">
    ...
    {!creating&&selected&&selected.character_id&&inThisRoom&&<div className="border-t border-[rgb(var(--sep-colour-60482e))]/35 pt-3">
