...
def patch_locations():
    ...
    s=rep(s,'      id, order_id, room_id,\n      background_colour, speech_colour, action_colour, system_colour,','      id, order_id, room_id, description_changed_at,\n      background_colour, speech_colour, action_colour, system_colour,','hq timestamp select')
...
def main():
    ...
    backup(); patch_npc_actions(); patch_npc_panel(); patch_locations(); write_sql()
    ...
    print('Code revert: python patch_npc_location_improvements.py --revert')
