...
(_, index) => (
<i
key={r${index}} className="sep-rain" style={{ left: ``${ (index * 37) % 103 }%,
...
return (
<i
key={s${index}} className="sep-snow" style={{ left: ``${ (index * 41) % 101 }%,
...
return (
<i
key={h${index}} className="sep-hail" style={{ left:${ (index * 43) % 103 }%,
...
radial-gradient(
ellipse at center,
rgba(210, 215, 210, 0.22),
rgba(160, 170, 165, 0.1)
38%,
transparent 70%
);
