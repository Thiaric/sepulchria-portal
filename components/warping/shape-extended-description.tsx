...
>
  ...
  <span className="h-px flex-1 bg-[rgb(var(--sep-colour-60482e))]/45 transition group-hover:bg-[rgb(var(--sep-colour-8d6d3e))]/65 components_warping_shape_extended_description_span_text_4" />
      ...
      {expanded ? (
  <div className="mt-2 components_warping_shape_extended_description_div_container_2">
    <div className="border-l-2 border-[rgb(var(--sep-colour-60482e))]/45 bg-[rgb(var(--sep-colour-120e0b))]/55 px-3 py-2.5">
      <RichTextContentClient
        body={body}
        className="
          text-[10px]
