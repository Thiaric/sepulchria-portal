    ...
    return (
      ...
      >
        <div className="mx-auto max-w-7xl border border-[rgb(var(--sep-colour-60482e))]/50 bg-[rgb(var(--sep-colour-120e0b))] p-6 text-center components_codex_public_codex_div_codex_first">
          ...
          <p className="mt-2 text-sm text-[rgb(var(--sep-colour-9e907d))] components_codex_public_codex_p_codex_first">
          ...
          >
            <div className="border border-[rgb(var(--sep-colour-60482e))]/40 bg-[rgb(var(--sep-colour-120e0b))] px-5 py-6 sm:px-8 sm:py-7 components_codex_public_codex_div_codex_chapter_3">
              {selectedChapter.body?.trim() ? (
                ...
                <div className="py-8 text-center components_codex_public_codex_div_container_3">
                  <p className="font-serif text-lg text-[rgb(var(--sep-colour-a9916e))] components_codex_public_codex_p_text_2">
                    This chapter has no
                    published content.
                  </p>

                  <p className="mt-1 text-xs text-[rgb(var(--sep-colour-756b5e))] components_codex_public_codex_p_text_3">
...
function ChapterFooterNavigation({
  ...
  return (
    <div className="mt-3 flex items-stretch justify-between gap-3 components_codex_public_codex_div_container_4">
      {previous ? (
        <button
          type="button"
          onClick={() =>
          ...
          className="min-w-0 flex-1 border border-[rgb(var(--sep-colour-60482e))]/35 bg-[rgb(var(--sep-colour-100c09))] px-4 py-3 text-left transition hover:border-[rgb(var(--sep-colour-85633a))] hover:bg-[rgb(var(--sep-colour-19120d))] components_codex_public_codex_button_action_2"
        >
          <span className="block text-[7px] uppercase tracking-[0.17em] text-[rgb(var(--sep-colour-756550))] components_codex_public_codex_span_text">
            ← Previous
          </span>

          <span className="mt-1 block truncate font-serif text-sm text-[rgb(var(--sep-colour-bca47e))] components_codex_public_codex_span_text_2">
            {previous.title}
          </span>
        </button>
      ) : (
        <div className="flex-1 components_codex_public_codex_div_container_5" />
      )}
      ...
      {next ? (
        <button
          ...
          className="min-w-0 flex-1 border border-[rgb(var(--sep-colour-60482e))]/35 bg-[rgb(var(--sep-colour-100c09))] px-4 py-3 text-right transition hover:border-[rgb(var(--sep-colour-85633a))] hover:bg-[rgb(var(--sep-colour-19120d))] components_codex_public_codex_button_action_3"
        >
          <span className="block text-[7px] uppercase tracking-[0.17em] text-[rgb(var(--sep-colour-756550))] components_codex_public_codex_span_text_3">
            Next →
          </span>

          <span className="mt-1 block truncate font-serif text-sm text-[rgb(var(--sep-colour-bca47e))] components_codex_public_codex_span_text_4">
            {next.title}
          </span>
        </button>
      ) : (
        <div className="flex-1 components_codex_public_codex_div_container_6" />
      )}
    </div>
  );
}