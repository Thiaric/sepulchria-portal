...
useEffect(() => {
  ...
  return (
    <main className="relative min-h-[100dvh] overflow-x-hidden bg-[rgb(var(--sep-colour-090706))] text-[rgb(var(--sep-colour-e8dcc4))] lg:h-[100dvh] lg:min-h-[680px] lg:overflow-hidden">
      {/* BACKGROUND */}
      <div className="pointer-events-none fixed inset-0 bg-[radial-gradient(circle_at_50%_-10%,rgba(var(--sep-rgb-135-91-42),0.22),transparent_38%),radial-gradient(circle_at_15%_45%,rgba(var(--sep-rgb-78-42-25),0.13),transparent_28%),linear-gradient(to_bottom,#130e0b_0%,#0b0807_50%,#070605_100%)]" />
      ...
      <div className="relative z-10 grid min-h-[100dvh] grid-rows-[auto_minmax(0,1fr)_auto] px-4 py-4 sm:px-6 lg:h-full lg:min-h-0 lg:px-8">
        ...
        <header className="mx-auto w-full max-w-[1500px] text-center">
          <h1 className="mt-1 font-serif text-4xl tracking-[0.12em] text-[rgb(var(--sep-colour-ead8b4))] drop-shadow-[0_6px_28px_rgba(var(--sep-rgb-0-0-0),0.85)] sm:text-5xl lg:text-6xl [@media(max-height:800px)]:text-4xl">
            SEPULCHRIA
          </h1>
        ...
        <section className="mx-auto grid min-h-0 w-full max-w-[1500px] gap-5 py-4 lg:grid-cols-[220px_minmax(0,1fr)_270px] xl:grid-cols-[240px_minmax(0,1fr)_300px] [@media(max-height:800px)]:gap-3 [@media(max-height:800px)]:py-2">
          ...
          <aside className="order-2 flex min-h-0 flex-col justify-center lg:order-1">
            <div className="relative border border-[rgb(var(--sep-colour-6b5032))]/55 bg-[rgb(var(--sep-colour-120d0a))]/86 p-3 shadow-[0_18px_60px_rgba(var(--sep-rgb-0-0-0),0.42)]">
              <div className="pointer-events-none absolute inset-1 border border-[rgb(var(--sep-colour-9a7547))]/12" />
          ...
          >
            <div className="absolute inset-[-7%] bg-[radial-gradient(ellipse_at_center,rgba(var(--sep-rgb-169-112-49),0.18),transparent_64%)] opacity-70 blur-2xl transition duration-1000 group-hover:opacity-100" />
  ...
  alt="Illustrated map of The Godscar"
                  ...
                  className="object-contain object-center brightness-[0.8] contrast-[1.08] saturate-[0.88] drop-shadow-[0_28px_40px_rgba(var(--sep-rgb-0-0-0),0.58)] transition duration-1000 group-hover:brightness-[0.9] group-hover:saturate-100"
                />
              </div>

              <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_55%,rgba(var(--sep-rgb-9-7-6),0.35)_80%,#090706_100%)]" />

              <div className="homepage-map-glow pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_58%,rgba(var(--sep-rgb-192-121-48),0.12),transparent_25%)] mix-blend-screen" />
            </div>
          </div>

          {/* RIGHT PANEL */}
          <aside className="order-3 flex min-h-0 flex-col justify-center">
            <div className="relative border border-[rgb(var(--sep-colour-6b5032))]/45 bg-[rgb(var(--sep-colour-110c09))]/82 px-5 py-4 shadow-[0_18px_60px_rgba(var(--sep-rgb-0-0-0),0.38)]">
        ...
        {/* FOOTER */}
        {/* FOOTER */}
<footer className="mx-auto w-full max-w-[1500px] border-t border-[rgb(var(--sep-colour-57412a))]/35 pt-3">
  ...
  <div className="mt-3 border-t border-[rgb(var(--sep-colour-57412a))]/20 pt-2 text-center">
    <p className="mx-auto max-w-4xl text-[8px] leading-4 text-[rgb(var(--sep-colour-706659))]">
      ...
      {aboutOpen ? (
        ...
        >
          ...
          {/* MODAL PANEL */}
          <section className="relative z-10 max-h-[90dvh] w-full max-w-[680px] overflow-y-auto border border-[rgb(var(--sep-colour-765937))]/80 bg-[rgb(var(--sep-colour-100c09))] shadow-[0_30px_100px_rgba(var(--sep-rgb-0-0-0),0.92)]">
...
function HomepageButton({
  ...
  return (
    <Link
      href={href}
      className={`group relative min-h-[68px] overflow-hidden border px-4 py-3 transition duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgb(var(--sep-colour-d4a460))] focus-visible:ring-offset-2 focus-visible:ring-offset-[rgb(var(--sep-colour-090706))] ${
        featured
          ? "border-[rgb(var(--sep-colour-a77a42))]/80 bg-[rgb(var(--sep-colour-332113))] shadow-[0_0_24px_rgba(var(--sep-rgb-159-105-46),0.13)] hover:-translate-y-0.5 hover:border-[rgb(var(--sep-colour-d4a460))] hover:bg-[rgb(var(--sep-colour-422a16))]"
