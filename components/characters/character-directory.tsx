...
function CharacterDirectoryCard({
  ...
  return (
    <Link
      ...
      className="group relative overflow-hidden border border-[#60482e]/45 bg-[#15100d]/95 transition duration-200 hover:-translate-y-0.5 hover:border-[#a17a49] hover:bg-[#1a130e]"
    >
      ...
      <div className="grid min-h-[215px] grid-cols-[125px_minmax(0,1fr)]">
        <CharacterPortrait
