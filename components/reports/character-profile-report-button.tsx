  ...
  return (
    <>
      ...
      {open && typeof document !== "undefined"
        ...
        <div
          className={[
            "fixed z-[20000] flex items-center justify-center bg-black/75 p-2 sm:p-4 components_reports_character_profile_report_button_div_report_character_profile",
        ...
        >
          <div className="flex max-h-full min-h-0 w-full max-w-xl flex-col overflow-hidden border border-[rgb(var(--sep-colour-73513a))] bg-[rgb(var(--sep-colour-100c09))] shadow-2xl components_reports_character_profile_report_button_div_report_character_profile_2">
            <div className="flex shrink-0 items-start justify-between gap-4 border-b border-[rgb(var(--sep-colour-59432c))]/45 px-4 py-3 sm:px-5 sm:py-4 components_reports_character_profile_report_button_div_report_character_profile_3">
            ...
            {reference ? (
              <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain p-4 sm:p-5 components_reports_character_profile_report_button_div_container">
              ...
              <div className="min-h-0 flex-1 space-y-4 overflow-y-auto overscroll-contain p-4 sm:space-y-5 sm:p-5 components_reports_character_profile_report_button_div_container_4">
