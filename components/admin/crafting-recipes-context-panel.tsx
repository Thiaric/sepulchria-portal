...
export function CraftingRecipesContextPanel() {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col components_admin_crafting_recipes_context_panel_div_crafting_recipes">
      ...
      <h2 className="mt-[4px] font-serif text-xl text-[rgb(var(--sep-colour-d8bf91))] components_admin_crafting_recipes_context_panel_h2_crafting_recipes">
        Crafting Recipes
      </h2>

      

      <label className="mt-[4px] block components_admin_crafting_recipes_context_panel_label_crafting_recipes">
        ...
        <span className="mt-[4px] block text-right text-[7px] uppercase tracking-[0.1em] text-[rgb(var(--sep-colour-6f6353))] components_admin_crafting_recipes_context_panel_span_crafting_recipes_2">
