...
export function AdminAncestryGiftSelector({
  ...
  return (
    <div className="border border-[rgb(var(--sep-colour-60482e))]/45 bg-[rgb(var(--sep-colour-100c09))] p-4 components_admin_admin_ancestry_gift_selector_div_container">
      ...
      <p
        ...
        style={{
          color:
            "rgb(var(--sep-global-c2))",
        }}
      >
        Choose up to two Feats
        available to the selected
        Ancestry. Changing Ancestry
        removes selections that are
        no longer eligible.
      </p>
      ...
      {selected.map(
        (giftId) => (
          <input
            className="components_admin_admin_ancestry_gift_selector_input_ancestry_gift_ids"
            key={giftId}
            type="hidden"
      ...
      {!raceId ? (
        <p
          className="mt-4 text-[10px] italic leading-5"
          style={{
            color:
              "rgb(var(--sep-global-c2))",
          }}
        >
          Select an Ancestry above
          to choose its Feats.
        </p>
      ) : eligible.length ? (
            ...
            (gift) => {
              ...
              return (
                <button
                  ...
                  className={[
                    `border p-3 text-left normal-case tracking-normal transition ${
                      checked
                        ? "border-[rgb(var(--sep-global-c1))] bg-[rgb(var(--sep-colour-2b1e13))]"
                        : "border-[rgb(var(--sep-colour-59432c))]/45 bg-[rgb(var(--sep-colour-0d0907))] hover:border-[rgb(var(--sep-global-c1))]"
                    } disabled:cursor-not-allowed disabled:opacity-35`,
                    "components_admin_admin_ancestry_gift_selector_button_action",
                  ]
                    .filter(Boolean)
                    .join(" ")}
                >
  ...
  <span
    className="font-serif text-sm normal-case tracking-normal"
    style={{
      color:
        "rgb(var(--sep-global-c1))",
      WebkitTextFillColor:
...
{gift.description ? (
  <p
    className="mt-2 text-[10px] leading-5 normal-case tracking-normal"
    style={{
      color:
        "rgb(var(--sep-global-c2))",
      WebkitTextFillColor:
  ...
  >
    {gift.description}
      ...
      <p
        className="mt-3 text-[9px] normal-case tracking-normal"
        style={{
          color:
            "rgb(var(--sep-global-c1))",
        }}
