...
# Normalize report controls (works on pristine or previous local attempt)
room = texts[ROOM]
room = room.replace('data-room-report-control="true" className="absolute right-3 top-3 z-50 pointer-events-auto"', 'className="absolute right-2 top-2 z-10"')
room = room.replace('className="absolute right-2 top-2 z-10"', 'data-room-report-control="true" className="absolute right-3 top-3 z-50 pointer-events-auto"')
if room.count('data-room-report-control="true"') != 3:
    raise SystemExit(f"Expected exactly 3 report controls, found {room.count(chr(100)+chr(97)+chr(116)+chr(97)+chr(45)+chr(114)+chr(111)+chr(111)+chr(109)+chr(45)+chr(114)+chr(101)+chr(112)+chr(111)+chr(114)+chr(116)+chr(45)+chr(99)+chr(111)+chr(110)+chr(116)+chr(114)+chr(111)+chr(108)+chr(61)+chr(34)+chr(116)+chr(114)+chr(117)+chr(101)+chr(34))}. Nothing written.")
