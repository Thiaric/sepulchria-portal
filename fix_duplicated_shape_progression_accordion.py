...
if (
    ...
    fail(
        "ShapeProgression.tsx is not in the expected broken progressive state."
    )

replacement = r'''"use client";
...
print()
print(
    "FIXED PROGRESSIVE SHAPE ACCORDION"
)
print(
    "- Each helper now enhances only its own parent Shape form."
)
print(
    "- A guard prevents the same form being enhanced twice."
)
print(
    "- Runtime mechanics, SQL changes and Shape data are untouched."
)
print()
print(
    "Refresh /admin/shapes after recompilation."
)
print(
