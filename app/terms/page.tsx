        ...
        <article className="mx-auto max-w-4xl border border-[rgb(var(--sep-colour-60482e))]/55 bg-[rgb(var(--sep-colour-110d0a))] p-6 shadow-[0_24px_80px_rgba(var(--sep-rgb-0-0-0),.45)] sm:p-10">
          ...
          <div className="mt-8 space-y-4 text-sm leading-7 text-[rgb(var(--sep-colour-aa9c88))]">
            ...
            <Section title="8. Virtual items, currency, paid extras and game features">
              ...
              <p>Real-money purchases are processed through Stripe Managed Payments, with Stripe acting as Merchant of Record. Stripe handles checkout and payment processing for those transactions. The product, contents, currency and price are shown before purchase.</p>
