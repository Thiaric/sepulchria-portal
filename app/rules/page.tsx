...
export const metadata: Metadata = { title: "Rules | Sepulchria" };
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#0b0807] px-5 text-[#e8dcc4]">
      <section className="w-full max-w-3xl border border-[#654b30]/55 bg-[#15100c] p-8 text-center sm:p-12">
        ...
        <h1 className="mt-4 font-serif text-5xl text-[#dfc89e]">Rules</h1>
        <p className="mx-auto mt-5 max-w-xl text-sm leading-7 text-[#9e907d]">The rules of play, conduct and character creation will be published here.</p>
