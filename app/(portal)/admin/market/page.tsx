          ...
          >
            ...
            <div className="flex items-center justify-between gap-3 md:col-span-2">
              <label className="flex items-center gap-2 text-xs text-[rgb(var(--sep-colour-aa987e))]">
                <input type="checkbox" name="isActive" defaultChecked className="accent-[rgb(var(--sep-colour-8b673d))]" />
                Active
              </label>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center justify-between gap-3 md:col-span-2">
                    <label className="flex items-center gap-2 text-xs text-[rgb(var(--sep-colour-aa987e))]">
                      <input type="checkbox" name="isActive" defaultChecked={shop.is_active} className="accent-[rgb(var(--sep-colour-8b673d))]" />
                      Active
                    </label>
                ...
                <div className="mt-6 border-t border-[rgb(var(--sep-colour-60482e))]/30 pt-5">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <label className="flex items-center gap-1 text-[8px] text-[rgb(var(--sep-colour-9b8970))]">
                        <input type="checkbox" name="isActive" defaultChecked className="accent-[rgb(var(--sep-colour-8b673d))]" />
                        Active
                      </label>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="min-w-0 self-center">
                            <p className="truncate font-serif text-sm text-[rgb(var(--sep-colour-cfb78e))]">
