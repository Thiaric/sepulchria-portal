  ...
  return (
    <main className="p-5 sm:p-7 lg:p-9">
      <div className="mx-auto max-w-6xl">
        ...
        <h2 className="mt-2 font-serif text-3xl text-[#e2cda4]">Expertise</h2>
        <p className="mt-3 max-w-3xl text-sm leading-6 text-[#9f927f]">
        ...
        <section className="mt-7 overflow-hidden border border-[#60482e]/45 bg-[#120e0b]">
          <div className="overflow-x-auto">
            <table className="w-full min-w-[760px] text-left">
              <thead className="border-b border-[#60482e]/45 bg-[#18110d]">
                <tr className="text-[9px] uppercase tracking-[0.18em] text-[#8f795c]">
              ...
              <tbody>
                {rows.map((row) => {
                  ...
                  return (
                    <tr key={row.character_id} className="border-b border-[#60482e]/25 align-top">
                      <td className="px-4 py-4 font-serif text-[#dcc49b]">{row.display_name}</td>
                      <td className="px-4 py-4 text-[#ead3a6]">{Number(row.expertise).toFixed(1)}</td>
                      <td className="px-4 py-4 text-xs text-[#a99b89]">
                      ...
                      <td className="px-4 py-4">
                        <form action={awardExpertise} className="flex min-w-[300px] gap-2">
                          ...
                          <input
                            ...
                            required
                            placeholder="+/- XP"
                            className="w-20 border border-[#60482e] bg-[#0b0807] px-2 py-2 text-xs text-[#e8dcc4]"
                          />
                          <input
                            name="note"
                            maxLength={240}
                            placeholder="Reason"
                            className="min-w-0 flex-1 border border-[#60482e] bg-[#0b0807] px-2 py-2 text-xs text-[#e8dcc4]"
                          />
                          <button className="border border-[#987344] bg-[#3b2919] px-3 py-2 text-[9px] uppercase tracking-[0.14em] text-[#efd6a8]">
                            Apply
                          </button>
                        </form>
                      </td>
