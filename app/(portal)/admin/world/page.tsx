    ...
    <main className="p-5 sm:p-7 lg:p-9">
      <div className="mx-auto max-w-5xl">
        ...
        <p className="mt-3 text-sm leading-7 text-[#a99b89]">
          Aureth can run its own seasonal weather and temperature.
          Staff may still impose temporary or permanent conditions
          whenever a plot requires them.
        </p>

        <div className="mt-5 grid gap-3 sm:grid-cols-4">
          <WorldFact label="Season" value={season} />
          <WorldFact label="Time of day" value={phase} />
          <WorldFact
        ...
        >
          ...
          <section className="border border-[#60482e]/45 bg-[#15100d] p-6">
            ...
            <p className="mt-2 text-xs leading-6 text-[#897b69]">
              Automatic weather uses season, game time, current
              conditions and temperature to choose believable transitions.
            </p>
            ...
            <label className="mt-5 flex gap-3 border border-[#60482e]/40 bg-[#100c09] p-4 text-sm text-[#c7b394]">
              ...
              <span>
                ...
                <span className="mt-1 block text-xs leading-5 text-[#847766]">
                  When enabled, Sepulchria&apos;s weather evolves
            ...
            <label className="mt-5 block text-xs text-[#9a815f]">
              ...
              >
                <option value="0">
                  No override — simulation may continue normally
                </option>
          ...
          <section className="border border-[#60482e]/45 bg-[#15100d] p-6 lg:col-span-2">
            <div className="grid gap-5 lg:grid-cols-2">
              <div>
                ...
                <p className="mt-2 text-xs leading-6 text-[#897b69]">
                  Automatic temperature reacts to season, game time
                  and current weather. It advances independently from
                  weather changes.
                </p>
                ...
                <label className="mt-5 flex gap-3 border border-[#60482e]/40 bg-[#100c09] p-4 text-sm text-[#c7b394]">
                  ...
                  <span>
                    ...
                    <span className="mt-1 block text-xs leading-5 text-[#847766]">
                      Keep temperature moving naturally even while staff
                      temporarily holds the weather.
                    </span>
                  </span>
                </label>
              </div>
              ...
              <div>
                ...
                <label className="mt-5 block text-xs text-[#9a815f]">
                  ...
                  >
                    <option value="0">
                      No override — keep automatic temperature
                    </option>
                    <option value="1">1 game hour</option>
                    <option value="3">3 game hours</option>
                    <option value="6">6 game hours</option>
                ...
                <p className="mt-3 text-[10px] leading-5 text-[#746a5d]">
                  To set a temporary temperature while keeping automation
                  enabled, enter the value and choose an override duration.
                  To keep a staff temperature indefinitely, turn Automatic
                  temperature off.
                </p>
              </div>
            </div>
          ...
          <section className="border border-[#60482e]/45 bg-[#100c09] p-5 lg:col-span-2">
            ...
            <p className="mt-3 text-xs leading-6 text-[#8f8271]">
              Spring favours showers, cloud and fog. Summer is warmer
              and clearer, with afternoon storms possible. Autumn favours
              cloud, rain and fog. Winter is colder, with rain converted
              to snow when temperatures permit. Temperature changes
              gradually through the day and is also modified by the current
              weather: clear skies tend warmer, while rain, storms, snow
              and hail pull conditions colder.
            </p>
          </section>
