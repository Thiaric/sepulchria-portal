...
export function WarpingPanel({presentCharacters,onBack}:{presentCharacters:C[];onBack:()=>void}){
 ...
 return <div className="border border-[rgb(var(--sep-colour-60482e))]/45 bg-[rgb(var(--sep-colour-100c09))] p-4">
  ...
  {!r.shapes?.length?<p className="mt-4 text-xs text-[rgb(var(--sep-colour-8f8271))]">You have no Shapes assigned.</p>:<>
   ...
   {(s?.target_mode==="other"||s?.target_mode==="either")?<div className="mt-3 flex gap-2"><button type="button" onClick={()=>{setTargetChoice("character");setWritten("")}} className={"border px-3 py-2 text-[8px] uppercase "+(targetChoice==="character"?"border-[rgb(var(--sep-colour-b88b50))] bg-[rgb(var(--sep-colour-2a1d12))]":"border-[rgb(var(--sep-colour-60482e))]/55")}>Character</button><button type="button" onClick={()=>{setTargetChoice("written");setTargets([])}} className={"border px-3 py-2 text-[8px] uppercase "+(targetChoice==="written"?"border-[rgb(var(--sep-colour-b88b50))] bg-[rgb(var(--sep-colour-2a1d12))]":"border-[rgb(var(--sep-colour-60482e))]/55")}>Written / Fate</button></div>:null}
   ...
   {s?.other_alternative_enabled&&targetChoice==="character"&&targets.some(id=>id!==r.character_id)?<div className="mt-3 space-y-2 border border-[rgb(var(--sep-colour-60482e))]/35 bg-[rgb(var(--sep-colour-15100d))] p-3"><p className="text-[8px] uppercase tracking-[.14em] text-[rgb(var(--sep-colour-806b50))]">Effect for each Other target</p>{targets.filter(id=>id!==r.character_id).map(id=>{const entry=presentCharacters.find(c=>c.id===id),choice=targetEffectChoices[id]??"beneficial";return <div key={id} className="flex flex-wrap items-center justify-between gap-2 border-t border-[rgb(var(--sep-colour-60482e))]/25 pt-2"><span className="text-[9px] text-[rgb(var(--sep-colour-c5ad86))]">{entry?.display_name??entry?.displayName??"Target"}</span><div className="flex gap-2"><button type="button" onClick={()=>setTargetEffectChoices(v=>({...v,[id]:"beneficial"}))} className={"border px-3 py-2 text-[8px] uppercase "+(choice==="beneficial"?"border-[rgb(var(--sep-colour-b88b50))] bg-[rgb(var(--sep-colour-2a1d12))]":"border-[rgb(var(--sep-colour-60482e))]/55")}>Beneficial</button><button type="button" onClick={()=>setTargetEffectChoices(v=>({...v,[id]:"harmful"}))} className={"border px-3 py-2 text-[8px] uppercase "+(choice==="harmful"?"border-[rgb(var(--sep-colour-b88b50))] bg-[rgb(var(--sep-colour-2a1d12))]":"border-[rgb(var(--sep-colour-60482e))]/55")}>Harmful</button></div></div>})}</div>:null}
