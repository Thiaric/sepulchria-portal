                    ...
                    >
                      <div className="flex items-center justify-between gap-4">
                        ...
                        <time
                          ...
                          className="text-[8px] uppercase tracking-[0.05em] text-[rgb(var(--sep-colour-776b5b))]"
                        >
                          {time}
                        </time>
                      </div>
                    ...
                    >
                      ...
                      <div className="flex w-[76px] shrink-0 flex-col game_components_roommessagelist_div_container_8">
                        ...
                        <time
                          ...
                          className="mt-1.5 block text-[7px] uppercase leading-4 tracking-[0.05em] text-[rgb(var(--sep-colour-776b5b))]"
                          style={{
                            color:
                              privateLocationTheme
                                ? privateLocationTheme.offgameTextColour
